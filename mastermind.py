...
class Round:
    ...
    def count_colors(self, guess: str) -> list[int]:
...
class Mastermind:
    ...
    def practice_tournament(self, player: Player, scsa_name: str, code_file: str) -> None:
    ...
    def play_tournament(self, player: Player, scsa: SCSA, num_rounds: int) -> Results:
        ...
        print(f"Total Time Used After SCSA '{scsa.name}': {self.time_used:.2f}s")
